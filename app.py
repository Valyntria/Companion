...
[data-testid="stChatMessage"] .stMarkdown p { color: #c9b99a !important; }
...
[data-testid="stChatInput"] textarea { background: #0f0e0b !important; border: none !important; border-bottom: 1px solid #2a2820 !important; border-radius: 0 !important; color: #e8e0d5 !important; font-family: 'Jost', sans-serif !important; font-weight: 200 !important; font-size: 0.9rem !important; caret-color: #c9a96e !important; box-shadow: none !important; padding-top: 0 !important; margin-top: 0 !important; vertical-align: bottom !important; }
...
if prompt := st.chat_input("Or type here..."):
    ...
    # Construct complete payload with System Context + Recent Thread
    formatted_messages = [{"role": "system", "content": build_system_prompt()}]
